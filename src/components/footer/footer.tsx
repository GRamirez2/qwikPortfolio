    ...
    return (
        ...
        <section class='w-full  bg-header pb-6'>
                ...
                <section class='max-w-screen-xl mx-auto'>
                    <article class='flex flex-col md:flex-row justify-around items-center text-lg min-h-fit p-10 mx-4 text-slate-600'>
                        <article class='w-full text-center md:w-1/2 lg:w-1/3 md:text-left mb-6 md:mb-0'>
                            ...
                            <p class='text-lg'>Email me at contact@georgeramirez.me</p>
                        </article>
            ...
            <article class='mt-8 text-center text-slate-600'>
                <p class='text-sm'>Developed with <a href="https://qwik.builder.io/" class='text-sky-600' target='_blank'> Qwik</a> + <a href="https://tailwindcss.com/" class='text-sky-600' target='_blank'>Tailwind</a></p>  
                <p class='text-xs'>© <a href="https://tech-mex.io/" target='_blank'>George Ramirez</a>, <span>{serverTime.value.year}</span> - All Rights Reserved</p>  
            </article>
        </section>
