...
export default component$(() => {
    return (
        ...
        <section class='w-full dark:bg-slate-700'>
            <article class='max-w-screen-xl mx-auto text-xl leading-8 text-slate-600 dark:text-slate-300'>
                <div class='mx-6'>
                    <p class='pb-3'>
                    ...
                    <section class='flex flex-row flex-wrap'>
                            ...
                            <div class='text-sm bg-header-dark dark:bg-slate-500 rounded-full px-4 mr-2 flex flex-row justify-between items-center mt-3'>
                                <img src="/monitor-24.png" alt="Front-end Logo" class=' w-4 mr-2 contrast-50 dark:contrast-75' />
                            Front-End
                            </div>

                            <div class='text-sm bg-header-dark dark:bg-slate-500  rounded-full px-4 mr-2 flex flex-row justify-between items-center mt-3'>
                                <img src="/manager-32.png" alt="Manager Logo" class=' w-4 mr-2 contrast-50 dark:contrast-75' />
                            Manager
                            </div>

                            <div class='text-sm bg-header-dark dark:bg-slate-500  rounded-full px-4 mr-2 flex flex-row justify-between items-center mt-3'>
                                <img src="/angular-24.png" alt="Angular Logo" class=' w-4 mr-2 contrast-50 dark:contrast-75' />
                            Angular
                            </div>

                            <div class='text-sm bg-header-dark dark:bg-slate-500  rounded-full px-4 mr-2 flex flex-row justify-between items-center mt-3'>
                                <img src="/node-js-32.png" alt="NodeJS Logo" class=' w-4 mr-2 contrast-50 dark:contrast-75' />
                            NodeJS
                            </div>

                            <div class='text-sm bg-header-dark dark:bg-slate-500  rounded-full px-4 mr-2 flex flex-row justify-between items-center mt-3'>
                                <img src="/location-24.png" alt="George Ramirez located in Little Rock Arkansas" class=' w-4 mr-2 contrast-50 dark:contrast-75' />
                            Little Rock, AR
                            </div>
